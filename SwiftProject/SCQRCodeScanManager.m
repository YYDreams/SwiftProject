...
@interface SCQRCodeScanManager ()<AVCaptureMetadataOutputObjectsDelegate, AVCaptureVideoDataOutputSampleBufferDelegate>
...
@implementation SCQRCodeScanManager
static SCQRCodeScanManager *_instance;
