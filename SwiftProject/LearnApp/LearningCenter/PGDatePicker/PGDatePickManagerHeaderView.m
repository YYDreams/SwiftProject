...
- (UIButton *)dateButton{
    if (!_dateButton) {
        ...
        [_dateButton addTarget:self action:@selector(dateButtonOnClick) forControlEvents:UIControlEventTouchUpInside];
...
- (UIButton *)timeButton{
    if (!_timeButton) {
        ...
        [_timeButton addTarget:self action:@selector(timeButtonOnClick) forControlEvents:UIControlEventTouchUpInside];
...
- (void)dateButtonOnClick{
    
    
}

- (void)timeButtonOnClick{
...
//    self.
//
//    [self addSubview:datePickManager.view]
