...
/** 扫描内容的 x 值 */
#define scanBorderX 0.5 * (1 - 0.7) * SCREEN_WIDTH
/** 扫描内容的 Y 值 */
#define scanBorderY 0.4 * (SCREEN_HEIGHT - scanBorderW)

@interface SCVIPScanView()
...
- (void)initialization {
    ...
    _scanningImageName = @"Frame 774034";
}
